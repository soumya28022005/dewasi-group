...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-500/5 dark:from-slate-950 dark:to-slate-900">
      ...
      <MobileDrawer
        ...
        pathname={pathname}
        userName={user.name || "Operator Admin"}
          ...
          <div className="space-y-1">
            {sections.map((section, sIdx) => (
              <div key={sIdx} className="space-y-1">
                <p className="px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-[#1e40af]/70 dark:text-blue-400 pt-3">
                  {section.title}
                </p>
      ...
      <div className="sticky top-20 space-y-6">
        ...
        <GradientCard variant="blue">
          <div className="flex items-center gap-3 p-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#1e3a8a] to-[#3b82f6] text-white shadow-lg shadow-[#1e3a8a]/30">
              <ShieldCheck className="h-6 w-6" />
            </div>
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1.5">
                <span className="rounded-full bg-blue-100 px-2 py-0.5 text-[9px] font-extrabold uppercase tracking-wide text-blue-800 dark:bg-blue-950/60 dark:text-blue-300">
                  {userRole}
                </span>
              </div>
