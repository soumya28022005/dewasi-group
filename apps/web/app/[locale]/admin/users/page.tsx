        ...
        <div className="flex flex-col gap-3 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full bg-blue-100 px-2.5 py-0.5 text-[10px] font-extrabold uppercase tracking-wide text-blue-800 dark:bg-blue-950/50 dark:text-blue-300">
                User Management
              </span>
            </div>
        ...
        <div className="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="relative min-w-[200px] sm:min-w-[240px]">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50/80 py-1.5 pl-8 pr-3 text-xs text-slate-900 outline-none transition focus:border-blue-600 focus:bg-white dark:border-slate-700 dark:bg-slate-800/60 dark:text-slate-100 dark:focus:border-blue-500"
            />
          </div>
        </div>
      </GradientCard>
