...
export function RequestsError({ onRetry, message }: RequestsErrorProps) {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-rose-200 bg-rose-50/50 p-8 text-center shadow-xs dark:border-rose-900/50 dark:bg-rose-950/20">
      ...
      <h2 className="mt-4 text-base font-bold text-slate-900 dark:text-white">
        Unable to load association requests
      </h2>

      <p className="mt-1 max-w-md text-xs text-slate-500 dark:text-slate-400">
        {message ||
          "An unexpected error occurred while fetching your clinic connection requests. Please try again."}
      </p>
